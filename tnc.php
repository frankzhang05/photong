    ...
    <div class="container hero">
        <div class="row">
            <div class="col">
                ...
                <p>
                    These terms and conditions outline the rules and regulations for the use of Photong's Website,
                    located at photong.ml.
                </p>
                <p>
                    By accessing this website we assume you accept these terms and conditions. Do not continue to use
                    Photong if you do not agree to take all of the terms and conditions stated on this page.
                </p>
                <p>
                ...
                <h2>Cookies</h2>
                <p>
                    We employ the use of cookies. By accessing Photong, you agreed to use cookies in agreement with the
                    Photong's Privacy Policy.
                </p>
                <p>
                ...
                <h2>License</h2>
                <p>
                    Unless otherwise stated, Photong and/or its licensors own the intellectual property rights for all
                    material on Photong. All intellectual property rights are reserved. You may access this from Photong
                ...
                <ul>
                    <li>Republish material from Photong</li>
                    <li>Sell, rent or sub-license material from Photong</li>
                    <li>Reproduce, duplicate or copy material from Photong</li>
                    <li>Redistribute content from Photong</li>
                </ul>
                <p>
                ...
                <p>
                    ...
                    compensates the absence of Photong; and (d) the link is in the context of general resource
                    information.
                </p>
                <p>
                ...
                <p>
                    ...
                    website, you must inform us by sending an e-mail to Photong. Please include your name, your
                ...
                <p>
                    No use of Photong's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.
                </p>
                ...
                <h2>Your Privacy</h2>
                <p>
                    Please read our <a href="privacy.php" target="_blank">Privacy Policy</a> for more details.
                </p>
